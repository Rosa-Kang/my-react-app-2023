...
const AccentColorEdit = () => {
    const updateProperty = (key, val) => document.body.style.setProperty(key, val)

  return (
      <>
          <h2>Color</h2>
          <label className='accent-color' htmlFor="accent-color">
              Accent Color
              <input
                  type='color'
                  defaultValue={getComputedStyle(document.body).getPropertyValue('--resume-accent')}
                  onChange={(e) => {
...
export default AccentColorEdit